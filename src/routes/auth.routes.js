...
const { sendOtp, verifyOtp, verifyWidgetToken, googleAuth, loginWithPassword, register, refresh, logout, checkAccount } = require("../controllers/auth.controller");
const { sendOtpRules, verifyOtpRules, verifyWidgetTokenRules, googleAuthRules, loginRules, registerRules, checkAccountRules } = require("../validators/auth.validator");
